    ...
    <div className="InnerUiSomer bg-[#1C1E20] container mx-auto w-[1250px] h-[700px]">
      ...
      <div className="innerbox flex">
        ...
        <div className="innerRight flex flex-col items-center justify-center ml-auto mt-[-50px]">
          <img src="/assets/ui_image.png" className="centralizedImage" />
          <p className="flex flex-col items-center text-center pt-[20px]">
            <a href="#" className="text-[#FBFAFA] text-[18px] center-head font-normal">
              Oja mi- Retail App Design
            </a>
          </p>
          {/* content */}
          <p className="text-[#FBFAFA] content-body text-[16px]">Oja mi- Retail App Design. Lorem ipsum dolor sit amet consectetur. In faucibus nisl etiam mauris diam venenatis amet placerat id.  Lorem ipsum dolor sit amet consectetur. In faucibus nisl etiam mauris diam venenatis amet placerat id.  </p>
        </div>
        {/* inner right ends */}
      </div>
      {/* end inner_box */}
