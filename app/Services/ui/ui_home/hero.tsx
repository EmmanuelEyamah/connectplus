    ...
    <section className="w-full h-full bg-[# ] py-32 px-24">
      <div className="mx-auto container w-full h-full relative flex flex-col lg:flex-row lg:flex justify-evenly items-start lg:items-center lg:pt-15 p-5 lg:p-0 gap-16 lg:gap-0">
        <div className="w-full lg:w-[500px] relative flex flex-col gap-3">
          <Typography
            className="text-[#4D4B4B] font-montserrat w-full text-center lg:text-left text-[18px] font-medium flex gap-1 items-center justify-center lg:justify-start overview" 
            {...commonProps}
          >
           OVERVIEW
          </Typography>
          <Typography
            className="text-[#000] text-[28px] font-montserrat text-center lg:text-left lg:text-[45px] font-bold w-full lg:w-[434px] leading-[130%] uiux"
            {...commonProps}
          >
            UI/UX Design
          </Typography>
