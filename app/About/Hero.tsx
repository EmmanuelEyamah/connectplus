    ...
    <section className="flex flex-col items-center pt-20 gap-16 bg-[#F3F3F3] ">
      <div className=" flex flex-col justify-center items-center gap-10 max-w-screen-xl mx-auto">
        <div className=" flex flex-col justify-center items-center gap-6 ">
          <Typography
            className=" text-gray-700 font-montserrat font-semibold text-lg leading-relaxed tracking-normal"
            {...commonProps}
          >
            About Us
          </Typography>
          <div className="flex flex-col justify-center items-center gap-6">
            <Typography
              className=" text-black font-worksans text-center text-4xl font-bold "
              {...commonProps}
            >
              Our Company
            </Typography>
            ...
            <Typography
              className="text-black-90 text-center font-montserrat text-base font-medium leading-8 max-w-screen-lg"
              {...commonProps}
            >
              We foster a culture of collaboration, where every team member is
          ...
          <section className="flex items-center gap-6">
            <Button
              {...commonProps}
              className=" bg-[#0A52F6] flex h-12 px-12 justify-center items-center gap-2 rounded-md text-white font-worksans text-base font-semibold "
            >
              {" "}
              Book A Call{" "}
            </Button>
            <Button
              {...commonProps}
              className=" bg-transparent rounded-md border border-gray-900 flex h-12 px-6 justify-center items-center gap-2 text-gray-900 font-worksans text-base font-semibold "
            >
              View Project{" "}
...
*/}
          {/*Video Container */}
          <video src="../assets/Team-Video.mp4" controls></video>
        </section>
      </div>
    </section>
  );
