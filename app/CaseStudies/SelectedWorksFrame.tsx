        ...
        <div className="flex flex-col gap-4 lg:gap-6 flex-wrap">
            <div className="pt-4 lg:pt-6">
                <ul className="flex flex-wrap gap-4 lg:gap-[12px] items-start">
                    <li>
                        <Button className="bg-[#0A52F6] rounded-[20px] w-[71px] h-[32px] flex items-center justify-center" {...commonProps}>
                            <span className="text-[10px] text-[#FBFAFA] font-medium leading-normal font-sans">Research</span>
                        </Button>
                    </li>
                    <li>
                        <Button className="bg-[#0A52F6] rounded-[20px] w-[71px] h-[32px] flex items-center justify-center" {...commonProps}>
                            <span className="text-[10px] text-[#FBFAFA] font-medium leading-normal font-sans">Figma</span>
                        </Button>
                    </li>
                    <li>
                        <Button className="bg-[#0A52F6] rounded-[20px] w-[71px] h-[32px] flex items-center justify-center" {...commonProps}>
                            <span className="text-[10px] text-[#FBFAFA] font-medium leading-normal font-sans">React</span>
                        </Button>
                    </li>
                    <li>
                        <Button className="bg-[#0A52F6] rounded-[20px] w-[71px] h-[32px] flex items-center justify-center" {...commonProps}>
                            <span className="text-[10px] text-[#FBFAFA] font-medium leading-normal font-sans">Django</span>
                        </Button>
                    </li>
                </ul>
            </div>
